      ...
      >
        <div>
          ...
          <p className="muted shipment-invoice-dialog-note">
            아래 형식으로 붙여넣으면 `셀픽주문번호` 또는 `상품주문번호` 기준으로 현재 워크시트의
            `택배사`, `운송장번호` 값을 채웁니다.
          </p>
        </div>
        <div className="shipment-invoice-dialog-example">
          <strong>입력 형식</strong>
          <pre>{`택배사\t운송장번호\t셀픽주문번호\nCJ대한통운\t123456789\tO20260326K0001\n\n상품주문번호\t택배사\t운송장번호\n1234567890\tCJ대한통운\t123456789`}</pre>
        </div>
        <textarea
          ...
          placeholder={"택배사\t운송장번호\t셀픽주문번호 또는 상품주문번호\t택배사\t운송장번호"}
        />
