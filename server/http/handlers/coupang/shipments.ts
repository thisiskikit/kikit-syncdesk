  ...
  return summarizeResult({
    ...
    stats: response.syncSummary
      ? {
          ...
          degraded: response.syncSummary.degraded ?? false,
          failedStatuses: response.syncSummary.failedStatuses ?? [],
          autoAuditRecommended: response.syncSummary.autoAuditRecommended ?? false,
